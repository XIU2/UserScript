...
(function() {
    var bColor='#ffffff';
    if('dark'==$('html').attr('data-color-mode')){
        bColor='#0D1117';
    }
    var download_url = [
            ['https://gh.con.sh','美国'],
        ...
        style = ['padding:0 6px;margin-right: -1px;border-radius: 2px;background-color: '+bColor+';border-color: rgba(27, 31, 35, 0.1);font-size: 11px;color: #888888;'],
