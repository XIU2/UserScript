...
function: {
    ...
    */ //<<< 规则简单说明 >>>
        DBSite = {
            ...
            manhuagui: {
                host: ['www.manhuagui.com', 'www.mhgui.com'],
    ...
    function doesItSupport() {
        ...
        } else if (getCSS('meta[name="description"][content*="小说"], meta[name="description"][content*="章节"], meta[name="description"][content*="阅读"]') && getCSS('#content, .content, #chaptercontent, .chaptercontent, #BookText') && getXpath('//a[contains(text(), "下一章") or contains(text(), "下一页")]')) {
