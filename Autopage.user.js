...
// @version      2.8.8
// @author       X.I.U
// @description  无缝拼接下一页内容（瀑布流），目前支持：[所有使用「Discuz!、Flarum、DUX/XIU/D8(WP主题)」的网站]、百度、谷歌、必应、搜狗、头条搜索、360 搜索、微信搜索、贴吧、豆瓣、微博、NGA、V2EX、B 站(Bilibili)、煎蛋网、糗事百科、龙的天空、起点小说、IT之家、千图网、Pixabay、3DM、游侠网、游民星空、NexusMods、Steam 创意工坊、CS.RIN.RU、FitGirl、片库、茶杯狐、NO视频、低端影视、奈菲影视、91美剧网、音范丝、BT之家、萌番组、动漫花园、樱花动漫、爱恋动漫、AGE 动漫、Nyaa、SrkBT、RARBG、SubHD、423Down、不死鸟、扩展迷、极简插件、小众软件、动漫狂、漫画猫、漫画DB、HiComic、动漫之家、古风漫画网、PubMed、wikiHow、GreasyFork、Github、StackOverflow（以上仅一部分，更多的写不下了...
// @match        *://*/*
    ...
    */
        DBSite = {
            ...
            bilibili_search: {
                ...
                pager: {
                    type: 1,
                    nextLink: bilibili_search_functionNext,
                    pageElement: '//ul[contains(@class, "video-list")]/li | //script[contains(text(), "window.__INITIAL_STATE__")]',
                    insertPosition: ['css;ul.video-list', 3],
                ...
                function: {
                    after: bilibili_search_functionAfter
                }
            }, //         B 站(Bilibili) - 搜索页
            pianku: {
                SiteTypeID: 0,
    ...
    function bilibili_search_functionNext() {
        if (!location.search) return
    ...
    function bilibili_search_functionAfter() {
...
<div id="Autopage_number" title="1. 此处数字为 [当前页码] (可在脚本菜单中关闭)&#10;&#10;2. 鼠标左键点击此处 [临时暂停本页自动无缝翻页]（再次点击可恢复）">${pageNum._now}</div>`
    ...
    function doesItSupport() {
        ...
        } else if (document.querySelector('link[href*="themes/d8" i], script[src*="themes/d8"]')) {
