...
(function() {
    ...
    var download_url6 = "https://github.com.cnpmjs.org";
    var download_url6_name = "大陆CNPMJS";
...
//            var url6 = download_url6 + href CNPMJS节点在Release中不起作用，已注释
...
<div><a style="${download_releases_style}" class="btn user-btn-link" href="${url6}" rel="nofollow">${download_url6_name}</a></div>
</div>`
                $(this).after(div1);
            });
        }
    ...
    $(".dropdown-menu.dropdown-menu-sw.p-0 ul li:last-child").each(function () {
        ...
        var url6 = download_url6 +"/"+href_split[3]+"/"+href_split[4]+ "/archive/master.zip";
