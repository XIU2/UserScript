...
(function() {
    ...
    function doesItSupport() {
        ...
        } else if (getAllXpath('//*[@onclick][text()="加载更多" or text()="查看更多"]').length === 1) {
        ...
        if (webType != 1) {
            switch (webType) {
                ...
                case 9: // < 部分自带 自动无缝翻页 的网站 2 >
                    DBSite.loadmore.url('//*[@onclick][text()="加载更多" or text()="查看更多"]'); break;
    ...
    */ //<<< 规则简单说明 >>>
        DBSite = {
            ...
            wp_article: {
                ...
                pager: {
                    pageE: 'article',
                    replaceE: '.pagination, .paging-navigation',
                    scrollD: 2000
                }
