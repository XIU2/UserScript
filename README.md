...
| 脚本名称 | 脚本功能 | 安装 / 备用 |
| :---- | :---- | :----: |
| **知乎 美化** | 宽屏显示、隐藏文章开头大图、文章编辑页与实际文章宽度一致... | **[安装](https://greasyfork.org/zh-CN/scripts/412212) / [备用](https://cdn.jsdelivr.net/gh/XIU2/UserScript@master/Zhihu-Beautification.user.js)** |
